...
1. Never assert how a company uses data or makes money ("sells your viewing
   ...
   (netflix review: "sold to studios" was cut as an overclaim)
2. In extract steps, concrete beats vague: name the exact URL or menu path
   (netflix.com/account/getmyinfo), not "request your data archive".
   (netflix review: vague step rewritten to a URL)
...
3. Taglines: emotional precision beats snark or cliché. "They know what makes
   ...
   video." Describe the user's experience, not the industry critique.
   (netflix, tiktok reviews)
...
6. The first prompt line should make the user's agent interview before
   recommending ("ask me what I actually watched last month").
   (netflix review: added; keep doing this unprompted)
